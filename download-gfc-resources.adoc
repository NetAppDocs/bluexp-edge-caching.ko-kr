...
https://repo.cloudsync.netapp.com/gfc/2k16_GFC_2_1_0_31IMAGE.zip["NetApp GFC(Microsoft Hyper-V)를 포함한 Windows Server 2016, VHDX"^]
...
https://repo.cloudsync.netapp.com/gfc/2k19_GFC_2_1_0_31IMAGE.zip["NetApp GFC(Microsoft Hyper-V)를 포함한 Windows Server 2019. VHDX"^]

* 글로벌 파일 캐시 에지 소프트웨어:
+
https://repo.cloudsync.netapp.com/gfc/GFC-2-1-0-31-Release.exe["NetApp GFC 소프트웨어 설치 패키지(.EXE)"^]

* 글로벌 파일 캐시 문서:
+
https://repo.cloudsync.netapp.com/gfc/Global%20File%20Cache%202.1.0%20User%20Guide.pdf["NetApp 글로벌 파일 캐시 사용자 가이드(.pdf)"^]
...
NOTE: Windows Server 2016에서 전역 파일 캐시를 배포할 때는 .NET Framework 4.8 및 Windows Web View2 프레임워크를 사용해야 합니다.
...
자세한 내용은 를 참조하십시오 https://repo.cloudsync.netapp.com/gfc/Global%20File%20Cache%202.1.0%20User%20Guide.pdf["NetApp 글로벌 파일 캐시 사용자 가이드 를 참조하십시오"^].
