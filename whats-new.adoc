...
NetApp은 이 제품의 EOA를 발표하지만 NetApp은 최소 2027년 5월 31일까지 계속해서 지원합니다. https://mysupport.netapp.com/info/communications/CPC-00578.html["NetApp Global File Cache의 공급 중지 세부 정보를 참조하십시오"^].
